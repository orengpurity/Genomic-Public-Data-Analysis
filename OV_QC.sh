...
#Scrip preview
# Reanalysis of publicly available sequences on an ovarian failure (OV) study
# the scrip involves quality control run of three OV sequences using fastqc and multiqc packages. 
